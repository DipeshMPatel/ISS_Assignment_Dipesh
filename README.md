...
- [x] Multithreading: Thread Pool Executor, volatile Keyword, Thread-safe with respect to Instance Variables, Local Variables, Method Synchronization, and Block Synchronization
- [x] JSON
- [x] XML
- [x] JDBC
- [x] File read/write
